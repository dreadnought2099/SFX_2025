...
@section('main-content')
    ...
    <div class="p-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('products.index') }}" class=" text-white font-bold py-2 px-4 rounded">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl">
            <form action="{{ route('products.store') }}" method="post">
                ...
                <div class="flex gap-4">
                    <button type="submit"
                        class="bg-green-600 hover:bg-white text-white hover:text-green-600 border-1 border-color-green-600 cursor-pointer font-bold py-2 px-4 rounded">
                        Save Product
                    </button>
                    <button type="reset"
                        class="bg-gray-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded cursor-pointer">
                        Clear
                    </button>
                </div>
            </form>
